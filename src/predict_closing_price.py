...
def main():
    ...
    data = {
        ...
        'Value': [mse, next_day_closing_price[0]]  # Convert the closing price to a scalar value
    }
    df_results = pd.DataFrame(data)
    prediction_csv_path = os.path.join(current_dir, '../data/linear_regression_prediction.csv')
